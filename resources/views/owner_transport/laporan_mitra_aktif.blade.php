...
@section('content')
<div class="container">
    <h4 class="mb-3">Laporan Mitra Aktif</h4>
    ...
    <form method="GET" class="mb-3" id="filterForm">
        <div class="d-flex">
            ...
            <button class="btn btn-primary" style="margin-left: 5px">Cari</button>
        </div>
    </form>

    <div class="alert alert-info">
        Total Mitra Aktif: <strong>{{ $total }}</strong>
    </div>
    ...
    <div class="table-responsive mb-3">
        <table class="table table-bordered table-striped align-middle">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center text-muted">Tidak ada mitra aktif</td>
                </tr>
                @endforelse
            </tbody>
        </table>
